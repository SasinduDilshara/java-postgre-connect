...
//            {
//                int id = rs.getInt("id");
//                String obj = rs.getObject("inettype").toString();
//                String obj1 = rs.getObject("cidrtype").toString();
//                String obj2 = rs.getObject("macaddrtype").toString();
//                String obj3 = rs.getObject("macaddr8type").toString();
